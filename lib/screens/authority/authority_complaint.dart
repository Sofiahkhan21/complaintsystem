...
import 'package:complaintsystem/components/search_widget.dart';
...
class AuthorityComplaint extends StatefulWidget {
  const AuthorityComplaint({super.key});

  @override
  State<AuthorityComplaint> createState() => _AuthorityComplaintState();
}

class _AuthorityComplaintState extends State<AuthorityComplaint> {
  ...
  sendAssignList(id, title, detail) async {
    ...
    Map<String,dynamic> assignList={'sender':authority,'receiver':assignval,};
    print('$forwd ////////////////////');
    await _firestore.collection('complaint').doc(id).update({
      'forword': true,'assignList': FieldValue.arrayUnion([assignList]),
      'assignto': 'assigned',
      'forwordTo': '$assignval',
      '$forwd': true,
              ...
              Container(
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                              ...
                              hintText: 'Search here .........',hintStyle: TextStyle(color: MyColors.blue),
                  ...
                  Container(
                    ...
                    child: ListView.builder(
                      ...
                      itemCount:isSearching?filterList.length: mainList.length,
                      itemBuilder: (BuildContext context, int index) {
                        DocumentSnapshot id = snapshot.data!.docs[index];
                        String docId = id.id;
                        DocumentSnapshot document =isSearching?filterList[index]:  mainList[index];
                          var sender;
                          var receiver;
                        for (var i = 0; i < (document['assignList'] as List).length; i++) {
                          var item=document['assignList'][i];
                            print('$item >>>>>>>>>>>>>');
                        
                       
                          if(item['sender']==authority){
                            receiver=item['receiver'];
                            print('$receiver >>>>>>>>>>>>>');
                    
                    
                          }
                             if(item['receiver']==authority){
                            print('${item['sender']} ////////////////');
                            sender=item['sender'];
                          }
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Row(
                                         ...
                                         authority=='VC'?Container():   Container(
                                              width: 100,
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  TextWidget(
                                                    text:document['category']==null?'Not mention': document['category'],
                                                    textcolor: Colors.black,
                                                  ),
                                                ],
                                              ),
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  TextWidget(
                                                    text:document['faculty']=='User' && authority=='ADSA'?'Student': sender,
                                                    //  authority == 'ADSA' &&
                                                    //         document['faculty'] ==
                                                    //             'User'
                                                    //     ? 'Student'
                                        ...
                                        // Container(
                                        //   color: Colors.white,
                                        //   child: (document['attachment'] as List).isEmpty?Center(
                                        //                 child: Text("No images found"))
                                        //             : GestureDetector(
                                        //               onTap: (){
                                        //                 MyNavigation.push(context, ViewAttach(attachList:document['attachment'] ,));
                                        //               },
                                        //               child:     TextWidget(
                                          ...
                                          child:
                                           ...
                                           Theme(
                                            ...
                                            child: ExpansionTile(
                                              ...
                                              children: [
                                                (document['attachment'] as List).isEmpty
                                                    ? Center(
                                                        child: Text("No images found"))
                                                    : Container(
                                                                  ...
                                                                  : ListView.builder(
                                                                      ...
                                                                      itemBuilder:
                                                                        ...
                                                                        if (item2[
                                                                            ...
                                                                            document[
                                                                                'id']) {
                                                                          return authority!='ADSA'&& item2['target']=='Student'?Container(): Container(
                                                                            margin: EdgeInsets
                                                                                .only(
                                                                                    top:
                                                                                        15),
                                                                            child: Row(
                                                                              children: [
                                                                                Row(
                                                                                  ...
                                                                                  children: [
                                                                                    Container(
                                                                                      ...
                                                                                      alignment:
                                                                                          Alignment.center,
                                                                                      child:
                                                                                          TextWidget(textoverflow: TextOverflow.ellipsis,
                                                                                 ...
                                                                                 Container(
                                                                                child: (item2['attachment'] as List).isEmpty?Container():
                                                                                GestureDetector(
                                                                                  onTap: (){
                                                                                    MyNavigation.push(context, ViewAttach(attachList: item2['attachment'],));
                                                                                  },
                                                                                  child: Icon(Icons.file_copy_outlined,color: MyColors.blue,),
                                                                                ),
                                                                              )
                                                                              ],
                                                                            ),
