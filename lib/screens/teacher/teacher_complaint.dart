...
class TeacherComplaint extends StatefulWidget {
  const TeacherComplaint({super.key});

  @override
  State<TeacherComplaint> createState() => _TeacherComplaintState();
}

class _TeacherComplaintState extends State<TeacherComplaint> {
    ...
    return Scaffold(
        ...
        body: StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance
              .collection('complaint').where('faculty',isEqualTo: 'Teacher')
                                                    ...
                                                    itemBuilder:
                                                      ...
                                                      return Container(
                                                        child: data['sender'] ==
                                                            ...
                                                            ? Row(
                                                              children: [
                                                                TextWidget(text:'ADSA',size: 15,fontWeight: FontWeight.w400,),
                                                            ...
                                                            : Row(
                                                              children: [
                                                                   Icon(Icons.arrow_forward,size: 20,),
                                                                      SizedBox(width: 5,),
                                                                TextWidget(text:
                                                                    '${data['receiver']}',size: 15,fontWeight: FontWeight.w400,),
